...
*    PARAM: None.
*    RETURN:  queue pointer of type queue_ty, if there is not enough 
...
*    PARAM: queue pointer.
*    RETURN: none.
*    BUGS: if the queue is empty or invalid the result is undefined.
****************************************************************************/
...
*    BUGS: if the list is empty will return an undefined result. 
****************************************************************************/
